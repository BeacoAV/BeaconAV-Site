...
export const services: Service[] = [
  {
    ...
    description: 'Professional live event audio from front-of-house through IEM â engineered and operated by experienced audio technicians.',
    capabilities: [
    ...
    metaDescription: 'Professional audio production for live events nationwide. PA systems, wireless mics, front-of-house mixing, and broadcast feeds â any size, any city.',
  },
  {
    ...
    description: 'End-to-end video production for live events â from multi-camera IMAG to projection mapping and content playback.',
    capabilities: [
      'Multi-camera IMAG (image magnification) for large audiences',
      'Projection systems â single, double, and blended configurations',
  ...
  },
  {
    ...
    description: 'From atmospheric uplighting to full stage wash and intelligent moving lights â professional lighting design and operation for any event.',
    capabilities: [
    ...
    metaDescription: 'Professional lighting design and production for live events â stage wash, intelligent fixtures, uplighting, and custom branding. Any venue, any city.',
  },
  {
    slug: 'staging',
    shortTitle: 'Staging',
    ...
    description: 'Modular stage systems, custom scenic builds, and set design â fully installed and struck by our production team.',
    capabilities: [
  ...
  },
  {
    ...
    description: 'Professional live streaming and hybrid event production â broadcast-quality output delivered to any platform, any audience size.',
    capabilities: [
  ...
  },
  {
    ...
    description: 'Indoor and outdoor LED video wall solutions â custom pixel pitch, configurations, and content â fully managed by our technical team.',
    capabilities: [
    ...
    metaDescription: 'Indoor and outdoor LED video walls for live events. Custom configurations, content integration, and full technical management â any event, any city.',
  },
  {
    ...
    description: 'Complete general session production for conferences, corporate events, and large-format meetings â audio, video, lighting, staging, and crew all under one roof.',
    capabilities: [
    ...
    metaDescription: 'Full-scale general session production for conferences and corporate events. Complete AV, staging, lighting, and crew â nationwide.',
  },
];
